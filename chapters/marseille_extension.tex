...
A clean English--Marseille expansion follows a short path:

\begin{enumerate}
\item State the parent question and the English card's position.
\item Read the English suit and number without assistance from the Marseille
      image.
\item Ask what detail is missing: material texture, emotional container,
      direction, boundary, resource, or relationship.
\item Invite the Marseille Minor to illuminate that detail.
\item Observe the suit, number, court, pip geometry, and any guide emphasis in
      the Marseille card.
\item Return the observation to the parent card and test whether it clarifies,
      complicates, or contradicts the first reading.
\item Keep the English meaning as the canonical parent and record any unresolved
      tension rather than forcing a synthesis.
\end{enumerate}

The return matters as much as the descent. A reader who only descends accumulates
detail until the original question disappears. A reader who returns carries the
small object back into the room and asks whether the room has become more
livable.

\section{Worked cross-readings}

\subsection{The message that changes the table}

Suppose an English Five of Diamonds appears in a position asking what will
change a practical arrangement. The English reading is a turn in material or
communicative life: news, an offer, a document, a transaction, or a change in
resources. A Marseille Five of Coins may show the material body of that turn:
coins divided, crossed, opened, or gathered. The reader asks whether the
message changes ownership, makes a cost visible, or creates a new exchange.

The Marseille image does not become ``good news'' merely because the coins look
balanced. It tells the reader where to look for the turn: in value, possession,
exchange, or the practical weight of a promise.

\subsection{The relation with a cup in its hands}

Suppose an English Two of Hearts appears between a Queen of Hearts and a Ten of
Diamonds. The English line already speaks of feeling entering mature emotional
intelligence and moving toward a concrete result. A Marseille Two of Cups may
show whether the relation is mirrored, offered, enclosed, or unable to hold
what it promises. The child card does not decide whether the relationship will
last. It gives the reader a vessel in which to examine what ``partnership'' can
actually contain.

If the pip field is divided, the English Two's possibility of separation remains
available. If it is harmonious, that may support mutuality, but the surrounding
Queen and Ten still determine what kind of mutuality can become worldly.

\subsection{The worker carrying fire}

Suppose an English Eight of Clubs appears as the next movement in a reading. It
describes effort, news, or enterprise approaching a destination. A Marseille
Eight of Batons can show whether that movement travels as a straight reach, a
repeated rhythm, a crowded growth, or a broken line. A Knight of Batons as a
child may identify the movement's carrier: not necessarily a literal rider, but
an agency in transit.

The English Eight still says ``approach.'' The Marseille detail asks what is
travelling, how much force it carries, and what kind of hand can receive it.

\subsection{The difficult edge}

Suppose an English Seven of Spades appears beneath a hopeful Hearts card. The
English reading names a test, boundary, or difficult truth requiring careful
handling. A Marseille Seven of Swords may reveal a crossing, enclosure, or
asymmetry in the way the difficulty is being managed. It does not soften the
test into a hidden blessing. It may show the exact place where honesty, defense,
separation, or decision is required.

The reader returns to the English question: what must be handled before this
can proceed? The pip geometry supplies a map of the edge. It does not remove
the edge.

\section{When the Minor refuses the parent}

Sometimes the Marseille card does not clarify. It resists. The pip geometry may
seem to tell a different story from the English operation; the Knight may arrive
when the reader expected a settled court; the suit bridge may feel too narrow.
This is not necessarily a mistake. Record the refusal as a live tension:

\begin{quote}
The English parent says what is happening. The Marseille child shows what the
reader cannot yet make fit.
\end{quote}

The reader may ask a smaller question, consult a second instrument, wait for
later evidence, or reach $T\_STOP$ with the tension still open. A useful
extension does not always resolve the card. Sometimes it tells us where the
world has not yet finished becoming legible.
